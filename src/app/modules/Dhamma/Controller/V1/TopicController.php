...
use Dhamma\Transformer\Topic as TopicTransformer;
...
class TopicController extends AbstractController
{
    ...
    public function createAction()
    {
        ...
        $myTopic = new TopicModel();
        $myTopic->name = (string) $formData['name'];
        $myTopic->description = (string) $formData['description'];
        $myTopic->displayorder = (int) $formData['displayorder'];
        $myTopic->status = (int) $formData['status'];
    ...
    public function updatefieldAction(int $id = 0)
    {
        ...
        $myTopic->{$formData['field']} = $formData['value'];
    ...
    public function formsourceAction()
    {
        return $this->respondWithArray([
            'statusList' => TopicModel::getStatusList()
        ], 'records');
    }
}
